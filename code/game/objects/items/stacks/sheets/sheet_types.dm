...
GLOBAL_LIST_INIT(wood_recipes, list ( \
	...
	new/datum/stack_recipe("mortar", /obj/item/reagent_containers/glass/beaker/mortar, 2, time = 30),\
	new/datum/stack_recipe("pestle", /obj/item/pestle, 2 , time = 30),\
	new/datum/stack_recipe("quenching barrel", /obj/structure/quenching_barrel, 20, time = 100, one_per_turf = TRUE, on_floor = TRUE),\
	new/datum/stack_recipe("tool handle", /obj/item/handle, 1, 4, 50, on_floor = TRUE), \
	new/datum/stack_recipe("long tool handle", /obj/item/handle/long, 1, 2, 50, on_floor = TRUE)\
